...
exports.MonthEndEncoder = void 0;
...
class MonthEndEncoder {
    ...
    fetchTrialBalance(period, entities, returnAgent = "FIN-Agent", priority = "1") {
    ...
    reconcileBank(period, returnAgent = "FIN-Agent", priority = "1") {
        return this.enc.encode({
    ...
    postAccruals(period, returnAgent = "FIN-Agent", priority = "1") {
        return this.enc.encode({
    ...
    varianceAnalysis(period, prevPeriod, returnAgent = "FIN-Agent", priority = "2") {
        return this.enc.encode({
            task: "CALC", domain: "FIN",
    ...
    generateManagementAccounts(period, returnAgent = "FIN-Agent", priority = "2") {
        return this.enc.encode({
    ...
    logCloseCertification(period, actor = "FIN-Agent", status = "certified", returnAgent = "AUD-Agent", priority = "2") {
        return this.enc.encode({
            task: "LOG", domain: "FIN",
    ...
    fullClose(period, prevPeriod, entities) {
        return [
...
exports.MonthEndEncoder = MonthEndEncoder;
//# sourceMappingURL=monthEndEncoder.js.map